...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://poolprax.sensotrend.fi/tpapi',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://poolprax.sensotrend.fi/tpupload',
  DATA_URL: process.env.DATA_URL || 'https://poolprax.sensotrend.fi/tpdata',
