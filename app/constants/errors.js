...
module.exports = {
  ...
  E_MEDTRONIC_UNSUPPORTED: 'Sensotrend Uploader does not support Minimed pumps 522, 722 or older, or the newer 6-series pumps. Sorry...',
  E_MEDTRONIC_UPLOAD: 'Make sure no other software (e.g. CareLink, OpenAPS, Loop) is talking to your pump. Otherwise, please see the error details below or contact Sensotrend Support.',
  ...
  E_SERVER_ERR: 'Sorry, the Sensotrend servers appear to be down',
  ...
  E_DEXCOM_CONNECTION: 'Sensotrend is having trouble connecting to your Dexcom receiver. Please make sure your other Dexcom uploading software programs are closed (like Dexcom Clarity or Glooko/Diasend). You can also try using another micro-USB cable. Some micro-USB cables are designed to carry a signal for power only.',
